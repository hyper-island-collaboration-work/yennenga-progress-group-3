  ...
  return (
    <div className="topbar-container fixed top-0 z-10 flex h-20 w-full items-center justify-between bg-umber px-10 py-4 font-['Arial'] text-lg font-semibold leading-10">
      <NavLink to="/Whistleblowing">
        <div className="inline-flex py-1 px-8 items-center justify-center gap-2 rounded-3xl bg-black transition delay-100 ease-in-out hover:bg-dark-blue">
      ...
      <NavLink to="/Donation">
        <div className="topbar-button flex inline-flex h-11 items-center justify-center gap-6">
          <button className="Donate-btn py-0.5 px-8 inline-flex justify-center rounded-3xl border-2 border-burkina-blue bg-burkina-blue transition delay-100 ease-in-out hover:border-dark-blue hover:bg-dark-blue">
            Donate
          </button>
        </div>
      </NavLink>
