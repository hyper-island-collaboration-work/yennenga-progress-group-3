...
function WhistleBlowing() {
  return (
    <div className="flex justify-center items-center absolute top-[2600px] w-full h-full bg-sand" style={{ height: '600px' }}>
      <div className="max-w-lg mx-auto p-6 relative">
        <button
          className="whistlenlowing-btn relative overflow-hidden bg-black rounded-full py-8 px-16 text-white font-bold hover:bg-dark-blue hover:border dark-blue transition duration-300"
